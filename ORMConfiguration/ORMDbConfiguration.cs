...
namespace ORMConfiguration
{
    public class ORMDbConfiguration : DbConfiguration
    {
        public ORMDbConfiguration()
        {
            ...
            //因为用到了EF，所以这里的entityFramework配置里面的invariantName与connectionStrings里面的providerName都要对应为DbProviderFactories里面注册的名字invariant="System.Data.SqlServerCe.4.0"，否则会提示没有注册System.Data.SqlServerCe.4.0。
        }
    }
}
